...
$convertButton.Add_Click({
    ...
    if ([string]::IsNullOrEmpty($inputTextBox.Text) -or !(Test-Path $inputTextBox.Text -PathType Leaf)) {
        [System.Windows.Forms.MessageBox]::Show("请选择有效的输入脚本文件", "错误", [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Error)
        return
    }
